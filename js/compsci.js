...
window.onload = function() {
    ...
    class BinusChat{
      ...
      create_title(){
        ...
        title.textContent = 'Computer Science'
      ...
      send_message(message){
        ...
        db.ref('compsci/').once('value', function(message_object) {
          var index = parseFloat(message_object.numChildren()) + 1
          db.ref('compsci/' + `message_${index}`).set({
      ...
      refresh_chat(){
        ...
        db.ref('compsci/').on('value', function(messages_object) {
